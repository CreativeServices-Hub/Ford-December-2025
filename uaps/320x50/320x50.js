...
lib.ssMetadata = [
		{name:"320x50_atlas_1", frames: [[322,0,71,30],[0,0,320,50]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,71,30);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(147.5,21,1,1,0,0,0,35.5,15);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:151.5,alpha:1},29,cjs.Ease.get(1)).wait(211));
